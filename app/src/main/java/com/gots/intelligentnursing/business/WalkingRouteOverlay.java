...
public class WalkingRouteOverlay extends OverlayManager {
    ...
    private static final String TAG = "WalkingRouteOverlay";
    ...
    /**
     * 处理点击事件
     * @param i 被点击的step在{@link WalkingRouteLine#getAllStep()}中的索引
     * @return 是否处理了该点击事件
     */
    public boolean onRouteNodeClick(int i) {
        if (mRouteLine.getAllStep() != null
                && mRouteLine.getAllStep().get(i) != null) {
            LogUtil.i(TAG, "WalkingRouteOverlay onRouteNodeClick");
        }
        return false;
    }
