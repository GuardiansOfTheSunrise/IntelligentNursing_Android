...
public class DrivingRouteOverlay extends OverlayManager {
            ...
            for (DrivingStep step : mRouteLine.getAllStep()) {
                ...
                if (step.getEntrance() != null) {
                    overlayOptionses.add((new MarkerOptions())
                            ...
                            .extraInfo(b)
                            .icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_baidu_line_node)));
                }
                // 最后路段绘制出口点
        ...
        if (mRouteLine.getStarting() != null) {
            overlayOptionses.add((new MarkerOptions())
                    ...
                    .icon(getStartMarker() != null ? getStartMarker() :
                            BitmapDescriptorFactory.fromResource(R.drawable.ic_baidu_start))
                    .zIndex(10));
        }
        if (mRouteLine.getTerminal() != null) {
            overlayOptionses.add((new MarkerOptions())
                    ...
                    .icon(getTerminalMarker() != null ? getTerminalMarker() :
                            BitmapDescriptorFactory.fromResource(R.drawable.ic_baidu_end))
                    .zIndex(10));
        }
    ...
    public List<BitmapDescriptor> getCustomTextureList() {
        ...
        list.add(BitmapDescriptorFactory.fromResource(R.drawable.ic_baidu_road_blue_arrow));
        list.add(BitmapDescriptorFactory.fromResource(R.drawable.ic_baidu_road_green_arrow));
        list.add(BitmapDescriptorFactory.fromResource(R.drawable.ic_baidu_road_yellow_arrow));
        list.add(BitmapDescriptorFactory.fromResource(R.drawable.ic_baidu_road_red_arrow));
        list.add(BitmapDescriptorFactory.fromResource(R.drawable.ic_baidu_road_nofocus));
        return list;
    }
    /**
     * 覆写此方法以改变默认终点图标
    ...
    public boolean onRouteNodeClick(int i) {
        if (mRouteLine.getAllStep() != null
            ...
            Log.i(TAG, "DrivingRouteOverlay onRouteNodeClick");
        }
        return false;
    }
